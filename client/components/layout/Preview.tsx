...
export const Preview = ({ editingUrl }: Props) => {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 flex justify-center px-5 pb-4">
      <div className="pointer-events-auto flex max-w-full min-w-0 items-center gap-3 rounded-full bg-white py-1.5 pr-1.5 pl-5 text-neutral-900 shadow-xl ring ring-neutral-200 ring-inset dark:bg-black dark:text-white dark:ring-neutral-800">
        <span className="relative flex size-2 shrink-0">
          <span className="absolute inline-flex size-full animate-ping rounded-full bg-neutral-900 opacity-60 motion-reduce:animate-none dark:bg-white" />
          <span className="relative inline-flex size-2 rounded-full bg-neutral-900 dark:bg-white" />
        </span>
        <p className="min-w-0 truncate text-sm font-medium">Live preview</p>
