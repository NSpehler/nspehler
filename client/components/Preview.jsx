...
import { LogoutIcon, LightningBoltIcon } from "@heroicons/react/outline"
          ...
          <div className="flex items-center justify-between flex-wrap">
            ...
            <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-2">
              <Link href="/api/exit-preview">
                <a className="-mr-1 flex p-2 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-white">
