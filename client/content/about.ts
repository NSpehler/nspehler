...
export const about = {
  title: "About",
  description:
    "Full-stack developer with 15 years of experience, from leading Growth Engineering at Payfit and Alma to building products for Back Market, Intigriti and more.",
  intro: {
    headline:
      "Hey! I’m Nicolas, a full-stack developer building modern web and mobile applications, with a focus on automation and AI.",
    body: [
      "For the past 15 years I’ve helped companies scale through technology and automation: leading Growth Engineering teams at ",
      { label: "Payfit", href: "/projects/payfit" },
      " and ",
      { label: "Alma", href: "/projects/alma" },
      ", then as a freelance engineer for ",
      { label: "Back Market", href: "/projects/back-market-pro" },
      ", ",
      { label: "Intigriti", href: "/projects/intigriti" },
      " and clients like ",
      { label: "goalGetr", href: "/projects/goalgetr" },
      ", ",
      { label: "Nucase", href: "/projects/nucase" },
      " and ",
